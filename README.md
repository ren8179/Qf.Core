...
### 介绍
基于.net 10 的微服务开发框架,使用简化的DDD+CQRS设计
...
* **Qf.Core**
    ...
    你可以运行以下命令在你的项目中使用类库
    > PM> Install-Package Qf.Core -Version 2.1.0.0
...
* **Qf.Core.EFCore**
    ...
    你可以运行以下命令在你的项目中使用类库
    > PM> Install-Package Qf.Core.EFCore -Version 2.1.0.0
...
* **Qf.Core.Web**
    ...
    你可以运行以下命令在你的项目中使用类库
    > PM> Install-Package Qf.Core.Web -Version 2.1.0.0
